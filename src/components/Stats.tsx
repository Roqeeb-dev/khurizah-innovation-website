export default function Stats() {
  ...
  return (
    <section className="px-4 sm:px-6 lg:px-0">
      <div className="max-w-6xl mx-auto mt-12 rounded-3xl bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-700 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-6 sm:px-8 py-10 sm:py-14 shadow-xl">
